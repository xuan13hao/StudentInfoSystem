...
<table width="660" border="0" align="center" cellpadding="0" cellspacing="0"   class="redtable">
  <td>
    ...
    <th width="180" align="center">日期</th>
    <th width="100" align="center">日程信息</th>
    <th width="100" align="center">操作</th>
    
  </td>
 
  <%
  List<Dates> list=(List<Dates>)request.getAttribute("datesinfo");
  ...
  %>
	  <tr>
		...
		<td align="center" valign="middle"><%=ma.getDate()%></td>
		<td align="center" valign="middle"><%=ma.getThing()%></td>
	    <td align="center" valign="middle"><input type="button" value="删除" onclick="window.location='date?action=delete&mid=<%=ma.getId()%>'"/></td>
	  </tr>
