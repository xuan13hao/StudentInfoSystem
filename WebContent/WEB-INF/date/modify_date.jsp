...
<table width="660" border="0" align="center" cellpadding="0" cellspacing="0"   class="redtable">
  ...
  <form action="date" method="post">
	  ...
	  <tr>
		...
		<td align="center" valign="middle"><input type="text" name="date" value="<%=ma.getDate()%>"></td>
		<td align="center" valign="middle"><input type="text" name="thing" value="<%=ma.getThing()%>"></td>
