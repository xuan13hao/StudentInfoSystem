...
<table width="660" border="0" align="center" cellpadding="0" cellspacing="0"   class="redtable">
  ...
  <form action="friends" method="post">
	  ...
	  <tr>
		...
		<td align="center" valign="middle"><%=ma.getEmail()%><input type="hidden" name="email" value="<%=ma.getEmail()%>"></td>
		<td align="center" valign="middle"><input type="text" name="qq" value="<%=ma.getQq()%>"></td>
		<td align="center" valign="middle"><input type="text" name="username" value="<%=ma.getUsername()%>"></td>
		<td align="center" valign="middle"><input type="text" name="phone" value="<%=ma.getPhone()%>"></td>
		<td align="center" valign="middle"><input type="text" name="place" value="<%=ma.getPlace()%>"></td>
		<td align="center" valign="middle"><input type="text" name="name" value="<%=ma.getName()%>"></td>
		<td align="center" valign="middle"><input type="text" name="workplace" value="<%=ma.getWorkplace()%>"></td>
